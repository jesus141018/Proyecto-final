...
router.get('/', function(req, res, next) {
  connection.query('SELECT c.id, c.fecha, pc.nombre paciente, med.nombres medico, med.consultorio FROM cita_medica c, pacientes pc, medicos med WHERE pc.cedula=cedula_paciente AND med.cedula=cedula_medico;', function(error, results) {
    if (error) {
