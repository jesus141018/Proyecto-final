...
router.post('/agregar', (req, res) => {
  ...
  connection.query(`INSERT INTO medicos (cedula, nombres, apellidos, especialidad, consultorio, correo) VALUES (${cedula},'${nombres}', '${apellidos}', '${especialidad}', '${consultorio}', '${correo}')`, (error, result) => {
    if (error) {
